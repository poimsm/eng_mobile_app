...
class _ChallengePageState extends State<ChallengePage> {
      ...
      child: Row(
        ...
        children: [
          ...
          Padding(
            ...
            child: Image.asset('assets/fox.png', width: 100,))
        ],
      ),
    );
  }
  ...
  _meaning() {
    return Column(
      ...
      children: [
        ...
        Text('Correr muy rapido', style: TextStyle(
          color: Color(0xff595959),
          fontSize: 18,
        ),),
      ],
  ...
  _example() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('EXAMPLE SENTENCE', style: TextStyle(
          color: Colors.black87,
          fontSize: 16,
          fontWeight: FontWeight.bold
        ),),
        Text('When I was everything I like to go football', style: TextStyle(
          color: Color(0xff595959),
          fontSize: 18,
        ),),
      ],
